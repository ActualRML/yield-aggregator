...
This project is built for **learning and portfolio purposes**, with a focus on
vault–strategy separation, capital allocation, share-based accounting, and
test-driven development using **Foundry**.
...
- Manages interaction with the strategy  
